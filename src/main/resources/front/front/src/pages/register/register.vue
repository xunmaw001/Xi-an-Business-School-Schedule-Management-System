<template>
	...
	<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20221119/e47b609472f14bba85fbe4ea38b2ec99.jpg) no-repeat","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"padding":"30px 40px 40px 40px","boxShadow":"0px 0px 0px #ccc,inset 0px 0px 0px 0px #e0f8e8","margin":"20px 0 0 40%","borderColor":"#1170d2 #08b344 #08b344 #1170d2","borderRadius":"10% 10%","background":"rgba(255,255,255,.8)","borderWidth":"4px","width":"auto","minWidth":"800px","borderStyle":"solid double solid double","height":"auto"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"width":"100%","margin":"0 0 20px 0","fontSize":"20px","color":"#08b344","textAlign":"center","fontWeight":"bold"}'>西安工商学院课表管理系统注册</p></div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 24px","height":"auto"}' v-if="tableName=='xuesheng'" prop="nianji">
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 24px","height":"auto"}' v-if="tableName=='jiaoshi'" prop="jiaoshigonghao">
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 24px","height":"auto"}' v-if="tableName=='jiaoshi'" prop="zhicheng">
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 24px","height":"auto"}' v-if="tableName=='jiaoshi'" prop="dianhua">
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0px auto 24px","height":"auto"}' v-if="tableName=='jiaoshi'" prop="zhaopian">
...
export default {
    ...
    methods: {
      ...
      getUUID () {
        ...
        // 下二随
        xueshengjiaoshixingmingChange () {
          this.$http({
            url: `follow/jiaoshi/jiaoshixingming?columnValue=`+ this.registerForm.jiaoshixingming,
            method: "get",
            params: {}
          }).then(({ data }) => {
            if (data && data.code === 0) {
