	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="课程简介" prop="kechengjianjie">
					<el-input v-model="ruleForm.kechengjianjie" placeholder="课程简介" clearable  :readonly="ro.kechengjianjie"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="课程简介" prop="kechengjianjie">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="课程时长" prop="kechengshizhang">
					<el-input v-model="ruleForm.kechengshizhang" placeholder="课程时长" clearable  :readonly="ro.kechengshizhang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="课程时长" prop="kechengshizhang">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.kechengxiangqing = this.ruleForm.kechengxiangqing.replace(reg,'../../../springboot2n594/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
